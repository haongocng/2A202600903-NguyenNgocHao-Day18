...
def main():
    ...
    if OPENAI_API_KEY:
        ...
        llm_client = OpenAI(api_key=OPENAI_API_KEY, base_url=OPENAI_BASE_URL if OPENAI_BASE_URL else None)
    ...
    for i, item in enumerate(test_set):
        ...
        if llm_client and contexts:
            try:
                ...
                answer = clean_llm_response(resp.choices[0].message.content)
            except Exception:
                answer = contexts[0]
        else:
